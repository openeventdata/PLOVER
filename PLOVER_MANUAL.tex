...
~   & \textbf{Less frequently used codes}\\
 \hline
 PRE & Partially recognized entities. Territories like Transnistria that are not recognized by the US, see \autoref{partially-recognized-entities} \\
