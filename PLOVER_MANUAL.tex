...
\caption{General contexts (\textit{italicized contexts} have additional details in \autoref{chapter:contexts})}
...
military & military, including military assistance; only covers official state military bodies, not paramilitary or militia organization, law enforcement, or non-state armed actors \\
\hyperref[context:intelligence]{\textit{intelligence}} & gathering of information by state intelligence organizations, including more general discussions of those agencies \\
...
diplomatic & diplomacy, both international and domestic, e.g. government-rebel negotations \\
natural\_resource & natural resources \\
health & public health, disease outbreaks and epidemics, disease in general \\
natural\_disasters & disasters including both ``natural" and \\&\hspace{6pt} accidents/spills etc., includes climate change \\
migration  & migration, refugees, and displaced people \\
\hyperref[context:humanitarian]{\textit{humanitarian}} & humanitarian assistance generally \\
...
human\_rights & unspecified human rights in a general sense, often but not always literally including the term ``human rights'' \\ 
\hyperref[context:rights-freedoms]{\textit{rights\_freedoms}} & political rights and freedoms, civil liberties, press/media freedom, restrictions on civil rights\\
&\hspace{6pt} gathering etc.\\
\hyperref[context:terrorism]{\textit{terrorism}} & events related to terrorist groups and related anti-terrorism actions and policies \\
human\_security & access to water, food, housing, energy, land/property tenure (e.g. seizure of crops), etc. \\
gender & mentions of gender, women's issues, gender equality, etc., including abortion \\
\hyperref[context:lgbt]{\textit{lgbt}} & LGBTQ \\
religion\_ethnicity & religious, ethnic, or linguistic issues, including discrimination, violence, but also cooperation, or more broadly important mentions \\
...
misinformation & misinformation, influence ops, fake news; events with this context are not necessarily misinformation themselves, e.g. could be allegations of influence ops \\
technology & discussions of technological development, new technology, high-tech industry\\
\hyperref[context:political-institutions]{\textit{political\_institutions}} & non-routine interactions between formal political bodies, including parties \\
\hyperref[context:pro-democracy]{\textit{pro\_democracy}} & processes and initiatives associated with democratization \\
\hyperref[context:pro-autocracy]{\textit{pro\_autocracy}} & processes and initiatives associated with autocratization \\
crime & Any discussion of crimes or criminals, \textit{excluding} events that have one of the more specific crime contexts like trafficking \\
corruption &  misuse/abuse of public office, including corruption, bribery, cronyism, nepotism, abuse of public office  \\
illegal\_drugs & criminal possession, distribution, sale, or manufacturing of illegal drugs \\
trafficking & trafficking or smuggling of humans, drugs, animals, or other goods; both domestic and international \\
\end{longtable}
...
While reparations or voluntary settlements should be coded as \plcat{AID}, court-ordered payments should be coded as \plcat{SANCTION} events with the winner and court as actor and guilty party as recipient. 
...
The covert gathering of information by state intelligence organizations, including through tactics of espionage, overhead reconnaissance, and communications interception. Accusations and suspicions of covert intelligence gathering, as well as more general discussions of state intelligence organizations, should also be coded. However, this context field excludes (1) discussions of the use of clandestine methods to spread misinformation or influence ops, which should be coded under the 'misinformation' context category and (2) discussions of artificial intelligence that are unrelated to state intelligence organizations' intelligence gathering activities.

\section{Terrorism}\label{context:terrorism}

Includes events related to terrorist groups, terrorist actions, terrorist funding, or terrorist sponsors; as well as anti-terrorism activities and policies. Terrorism is defined as any activity that aims to harm, kill, or kidnap civilians or unarmed government employees in an effort to intimidate, coerce, and/or provoke fear in societies, governments, or groups therein.

\section{Humanitarian}\label{context:humanitarian}

Includes discussions related to the provision of aid or assistance for humanitarian crises by domestic or international governments, international organizations, corporations, or NGOs. It also includes discussions of cooperation among humanitarian agencies or discussions of humanitarian organizations themselves when references are made to these organizations' humanitarian activities. Examples of humanitarian assistance include 1) provision of aid, support, or assistance for disaster mitigation, prevention, preparedness, or response, 2) aid or assistance for refugees or children, 3) food aid or agricultural support, or 4) support or assistance for health emergencies and disease outbreaks.

\section{rights\_freedoms}\label{context:rights-freedoms}

\subsection{Common interactions}

"pro\_democracy", "pro\_autocracy"
...
Payments or other restitution for past harms inflicted by one group or state on another. The specific event type that is coded depends on how reparations came about. If court-ordered, these will be \plcat{SANCTION} events; voluntary agreements might be either \plcat{AID} or \plcat{AGREEMENT}, depending on whether payments/asset transfers have actually occurred or not. 
