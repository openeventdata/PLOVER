...
\begin{enumerate}
\item The country name---\texttt{actor/recipient}---is either a country designation for independent states, an entity designation for a very small number of non-independent territories, or a standardized identifier for an international non-state actors such as intergovernmental organizations; see Table \ref{tab:nonstate} below.
